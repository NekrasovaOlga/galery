...
export const ImageInfo = () => {
  ...
  const img = useSelector((state) => state.image.data);

  const { created_at: date, user, likes, downloads, views, urls } = img;
